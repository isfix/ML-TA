...
BASE_DIR = os.path.dirname(os.path.abspath(__file__)) # Assumes config.py is in the root of the trading_workflow package
# If main.py is one level up, adjust BASE_DIR or these paths accordingly.
# For Project 2 structure where config.py is inside trading_workflow/:
PROJECT_ROOT_DIR = os.path.dirname(BASE_DIR) # One level up from trading_workflow/
...
PRIMARY_MODEL_PAIRS_TIMEFRAMES = ["EURUSD_M5", "GBPUSD_M5"]
